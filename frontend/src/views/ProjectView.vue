...
<div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
  <div class="grid lg:grid-cols-3 gap-y-8 lg:gap-y-0 lg:gap-x-6 lg:gap-x-12">
      ...
      <div class="py-8 lg:pe-4 lg:pe-8">
        <div class="space-y-5 lg:space-y-8">
          ...
          <div class="flex items-center gap-x-5">
            ...
            <p class="text-xs text-gray-800 sm:text-sm dark:text-gray-200">January 18, 2023</p>
          </div>
            ...
            <div class="grid gap-3 lg:grid-cols-2">
              <div class="grid grid-cols-2 gap-3 lg:grid-cols-1">
                <figure class="relative w-full h-60">
                  <img class="absolute top-0 object-cover w-full h-full start-0 rounded-xl" src="https://images.unsplash.com/photo-1670272505340-d906d8d77d03?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80" alt="Image Description">
                </figure>
                <figure class="relative w-full h-60">
                  <img class="absolute top-0 object-cover w-full h-full start-0 rounded-xl" src="https://images.unsplash.com/photo-1671726203638-83742a2721a1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80" alt="Image Description">
                </figure>
              </div>
              <figure class="relative w-full h-72 sm:h-96 lg:h-full">
                <img class="absolute top-0 object-cover w-full h-full start-0 rounded-xl" src="https://images.unsplash.com/photo-1671726203394-491c8b574a0a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=988&q=80" alt="Image Description">
              </figure>
            </div>

            <span class="block mt-3 text-sm text-center text-gray-500">
              Working process
            </span>
          </div>
          ...
          <p class="text-lg text-gray-800 dark:text-gray-200">That's why we are excited to share that we now have a <a class="font-medium text-blue-600 decoration-2 hover:underline" href="#">free version of Preline</a>, which will allow individual designers, startups and other small teams a chance to create a culture of openness early on.</p>
          ...
          <figure>
            <img class="object-cover w-full rounded-xl" src="https://images.unsplash.com/photo-1671726203454-488ab18f7eda?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80" alt="Image Description">
          ...
          <ul class="space-y-5 text-lg text-gray-800 list-disc list-outside ps-5 dark:text-gray-200">
            <li class="ps-2">Preline allows us to collaborate in real time and is a really great way for leadership on the team to stay up-to-date with what everybody is working on," <a class="font-medium text-blue-600 decoration-2 hover:underline" href="#">said</a> Stewart Scott-Curran, Intercom's Director of Brand Design.</li>
            <li class="ps-2">Preline opened a new way of sharing. It's a persistent way for everyone to see and absorb each other's work," said David Scott, Creative Director at <a class="font-medium text-blue-600 decoration-2 hover:underline" href="#">Eventbrite</a>.</li>
          </ul>
          ...
          <div class="grid lg:flex lg:justify-between lg:items-center gap-y-5 lg:gap-y-0">
            ...
            <div class="flex justify-end items-center gap-x-1.5">
              ...
              <div class="inline-block hs-tooltip">
                <button type="button" class="flex items-center text-sm text-gray-500 hs-tooltip-toggle gap-x-2 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
              ...
              <div class="block h-3 mx-3 border-gray-300 border-e dark:border-gray-600"></div>
              ...
              <div class="relative inline-flex hs-dropdown">
                <button type="button" id="blog-article-share-dropdown" class="flex items-center text-sm text-gray-500 hs-dropdown-toggle gap-x-2 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
    ...
    <!-- Sidebar -->
    <div class="lg:col-span-1 lg:w-full lg:h-full lg:bg-gradient-to-r lg:from-gray-50 lg:via-transparent lg:to-transparent lg:dark:from-slate-800">
      <div class="sticky top-0 py-8 start-0 lg:ps-4 lg:ps-8">
        <!-- Avatar Media -->
        <div class="flex items-center pb-8 mb-8 border-b border-gray-200 group gap-x-3 dark:border-gray-700">
          <a class="flex-shrink-0 block" href="#">
            <img class="w-10 h-10 rounded-full" src="https://images.unsplash.com/photo-1669837401587-f9a4cfe3126e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80" alt="Image Description">
          </a>

          <a class="block group grow" href="">
            <h5 class="text-sm font-semibold text-gray-800 group-hover:text-gray-600 dark:group-hover:text-gray-400 dark:text-gray-200">
              Leyla Ludic
            </h5>
          ...
          <!-- Potential follow feature in the future -->
          <!-- <div class="grow">
        ...
        <div class="space-y-6">
          ...
          <a class="flex items-center group gap-x-6" href="#">
            ...
            <div class="relative flex-shrink-0 w-20 h-20 overflow-hidden rounded-lg">
              <img class="absolute top-0 object-cover w-full h-full rounded-lg start-0" src="https://images.unsplash.com/photo-1567016526105-22da7c13161a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1480&q=80" alt="Image Description">
            </div>
          </a>
          <!-- End Media -->
          ...
          <a class="flex items-center group gap-x-6" href="#">
            ...
            <div class="relative flex-shrink-0 w-20 h-20 overflow-hidden rounded-lg">
              <img class="absolute top-0 object-cover w-full h-full rounded-lg start-0" src="https://images.unsplash.com/photo-1542125387-c71274d94f0a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1480&q=80" alt="Image Description">
            </div>
          </a>
          <!-- End Media -->
          ...
          <a class="flex items-center group gap-x-6" href="#">
            ...
            <div class="relative flex-shrink-0 w-20 h-20 overflow-hidden rounded-lg">
              <img class="absolute top-0 object-cover w-full h-full rounded-lg start-0" src="https://images.unsplash.com/photo-1586232702178-f044c5f4d4b7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1480&q=80" alt="Image Description">
            </div>
          </a>
          <!-- End Media -->
        </div>
